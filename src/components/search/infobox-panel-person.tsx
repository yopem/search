...
interface InfoboxPanelPersonProps {
  title: string
  image?: string
  summary?: string
  ...
  return (
    <Card className="w-full">
      ...
      <CardContent className="space-y-3">
        {image && <InfoboxImage src={image} alt={title} aspectRatio="square" />}
        {truncatedSummary && (
...
export default InfoboxPanelPerson
